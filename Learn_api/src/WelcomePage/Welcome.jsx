      ...
      >
        ...
        >
          ...
          <p className="text-gray-200 text-sm mt-2">
            Get started with easy guides and resources to understand
        ...
        >
          ...
          <p className="text-gray-200 text-sm mt-2">
            Your data and learning journey remain private and safe with modern
            encryption.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-200 text-sm mt-2">
            Connect with crypto enthusiasts, share insights, and grow together
