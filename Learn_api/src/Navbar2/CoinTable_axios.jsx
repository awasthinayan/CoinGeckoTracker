          ...
          <div className="text-4xl text-center font-semibold">The Price of Bitcoin are given in <b className="glow2">{currency}</b></div>
            ...
            <div className="flex gap-4 justify-center items-center ">
                <button
                    ...
                    className="btn btn-primary btn-wide text-white text-2xl hover:button-pointer"
                >
                    Prev
                </button>
                <button 
                    onClick={() => setPage(page+1)} 
                    className="btn btn-secondary btn-wide text-white text-2xl hover:button-pointer"
                >
                    Next
                </button>
            </div>
